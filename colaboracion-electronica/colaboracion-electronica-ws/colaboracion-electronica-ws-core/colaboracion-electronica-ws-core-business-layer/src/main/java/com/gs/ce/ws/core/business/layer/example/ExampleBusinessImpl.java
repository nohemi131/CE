package com.gs.ce.ws.core.business.layer.example;
...
import com.gs.ce.ws.core.business.interfaces.example.IExampleBusiness;
...
public class ExampleBusinessImpl implements IExampleBusiness{
	...
	public ResponseExampleTO exampleBusinessMethod(RequestExampleTO requestExampleTO) throws Exception {
		...
		Example example=spExampleDAOImpl.invokeSpExample(requestExampleTO);
