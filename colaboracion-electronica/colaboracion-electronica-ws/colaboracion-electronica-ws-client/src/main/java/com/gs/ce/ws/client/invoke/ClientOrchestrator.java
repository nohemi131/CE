package com.gs.ce.ws.client.invoke;
...
import com.gs.ce.commons.utilities.client.properties.ConstantsApiLoader;
import com.gs.ce.commons.utilities.encript.CipherReflection;
import com.gs.ce.commons.utilities.time.TimeUtil;
import com.gs.ce.ws.core.entities.services.RequestTO;
import com.gs.ce.ws.core.entities.services.ResponseTO;

public class ClientOrchestrator extends ConstantsApiLoader{

	public static Logger log = Logger.getLogger(ClientOrchestrator.class);
	...
	public ClientOrchestrator(){		
        ...
        resourceWebTarget = client.target(propertie.getProperty("UrlWSOrchestrator")).path(propertie.getProperty("contextWSOrchestratorService"));
	}
