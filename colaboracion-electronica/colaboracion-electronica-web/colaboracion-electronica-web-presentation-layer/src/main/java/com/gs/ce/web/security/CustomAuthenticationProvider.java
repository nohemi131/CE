...
import com.gs.ce.ws.client.facade.ServiceFacadeOrchestratorImpl;
...
public class CustomAuthenticationProvider implements AuthenticationProvider{
    ...
    @Autowired
    private ServiceFacadeOrchestratorImpl serviceFacadeOrchestratorImpl;
	...
	public Authentication authenticate(Authentication authentication) {
        ...
        String pass = ((UsernamePasswordAuthenticationToken) authentication).getCredentials().toString();
        ...
        try {
        	...
        	try {
        		...
        		requestExampleTO.setUser(username);
        		requestExampleTO.setPass(pass);
				ResponseExampleTO responseExample = serviceFacadeOrchestratorImpl.getLoginServiceOrchestratorImpl().serviceExample(requestExampleTO, "CGT");
